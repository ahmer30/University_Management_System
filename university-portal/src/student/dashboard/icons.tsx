...
export function getNavIcon(icon: string, size = 20, color = "currentColor") {
  switch (icon) {
    case "home":     return <IconHome size={size} color={color} />;
    case "book":     return <IconBook size={size} color={color} />;
    case "chart":    return <IconChart size={size} color={color} />;
    case "calendar": return <IconCalendar size={size} color={color} />;
    case "clock":    return <IconClock size={size} color={color} />;
    case "mail":     return <IconMail size={size} color={color} />;
    case "settings": return <IconSettings size={size} color={color} />;
    default:         return <IconHome size={size} color={color} />;
  }
}
